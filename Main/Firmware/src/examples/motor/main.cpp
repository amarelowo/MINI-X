...
#define POT_PIN (25) // Analog pin used to connect the potentiometer center pin
...
ESC myESC (ESC_PIN, 1500, 2500, 800); // ESC_Name (PIN, Minimum Value, Maximum Value, Arm Value)
